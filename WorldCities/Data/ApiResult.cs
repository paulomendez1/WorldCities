...
namespace WorldCities.Data
{
    public class ApiResult<T>
    {
        ...
        /// type</param>
        /// <param name="pageIndex">Zero-based current page inde
        /// (0 = first page)</param>
        ...
        /// name</param>
        /// <param name="filterQuery">The filtering query (value
        /// lookup)</param>
        /// <returns>
        /// A object containing the IQueryable paged/sorted/filt
        /// result
        /// and all the relevant paging/sorting/filtering naviga
        /// info.
        /// </returns>
        ...
        /// <summary>
        /// TRUE if the current page has a next page, FALSE othe
        /// </summary>
