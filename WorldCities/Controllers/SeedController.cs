...
namespace WorldCities.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        {
            // prevents non-development environments from runnin
            ...
            for (int nRow = 2; nRow <= nEndRow; nRow++)
            {
                ...
                // skip this country if it already exists in the
                if (countriesByName.ContainsKey(countryName))
                    continue;
                // create the Country entity and fill it with xl
                ...
                // store the country in our lookup to retrieve i
            ...
            for (int nRow = 2; nRow <= nEndRow; nRow++)
            {
                ...
                // skip this city if it already exists in the da
                if (cities.ContainsKey((
                    ...
                    CountryId: countryId)))
                    continue;
                // create the City entity and fill it with xlsx
                var city = new City
                {
                    Name = name,
